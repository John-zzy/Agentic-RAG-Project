...
6. 如果要运行 Elasticsearch 或排查本地问题，读 [运维与排障](./operations/common-pitfalls.md)。
...
- [Elasticsearch 本地运行](./operations/elasticsearch/README.md)
- [Elasticsearch docker-compose](./operations/elasticsearch/docker-compose.yml)
